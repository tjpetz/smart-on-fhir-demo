...
function isUrlValid(userInput)
{
 ...
 function getURL()
 {
    ...
    let local = "local";let session = "session";
    let set = "set";let get = "get";
    if( isUrlValid(api_url) && isUrlValid(oauth_url) )
    {
       storageDriver({key: "api_url", value: api_url}, local, set);storageDriver({key: "api_url", value: api_url}, session, set);
       storageDriver({key: "oauth_url", value: oauth_url}, local, set);storageDriver({key: "oauth_url", value: oauth_url}, session, set);
       storageDriver({key: "client_id", value: client_id}, local, set);storageDriver({key: "client_id", value: client_id}, session, set);
